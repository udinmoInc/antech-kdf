...
- Crates: `antech-kdf`, `antech-kdf-core`, `antech-kdf-format`, `antech-kdf-types`, `antech-kdf-cli`, `antech-kdf-ffi`, `antech-kdf-research`
- C ABI via `antech-kdf-ffi`
- Research attackers, CUDA, and historical variants in `antech-kdf-research` only
