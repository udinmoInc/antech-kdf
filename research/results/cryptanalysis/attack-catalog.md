...
| A3_parent_prediction | Predict parents from partial state | FAILED to predict | 1.000 | 1.0000 | 0.00 | exact_matches=3/32767 (0.01%); Parents depend on full 256-bit state; partial prediction fails |
...
| A5_mitm_split | Meet-in-the-middle split at mid DAG | CORRECT (no savings) | 1.000 | 1.0000 | 9.40 | State-dependent parents prevent independent half-DAG evaluation. |
...
| A8_packed_prefetch_full_eval | Full DAG with packed u64 layout + prefetch (no node skip) | CORRECT | 0.512 | 1.0000 | 18.35 | Same num_blocks mixes; attack_work/full_work≈0.512 via schedule only |
