//! Canonical Variant K2 — Stronger Quad-TMTO Graph.
//! 4-way directed acyclic memory graph enforces steep O((N/M)^4) recomputation penalty.
...
impl VariantK2 {
    pub fn new() -> Self {
        Self {
            ...
            dependency_depth: 550000, // Defender latency ~112 ms
            passes: 1,
        }
    }
